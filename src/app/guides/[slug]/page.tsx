...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://freshersbridge.in/guides/${guide.slug}`,
    },
    openGraph: {
      title,
      description,
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 w-full space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Reading Sidebar (4 cols - Sticky alongside article) */}
      ...
      {/* Structured FAQ & Related Resources: 2-Column Layout (Zero Layout Shift on FAQ Toggle) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pt-8 border-t border-border mt-8">
        
        {/* Left Column (8 cols): FAQ Accordion, Tags & Fact-Checking Note */}
        ...
        {/* Right Column (4 cols): Related Career Guides (Self-start, Zero Jitter) */}
        <aside className="lg:col-span-4 space-y-6 self-start">
          ...
          {/* Quick Career Tools Card beside FAQs */}
          <div className="rounded-2xl border border-indigo-200 dark:border-indigo-900/60 bg-gradient-to-br from-indigo-50/70 via-card to-card p-6 shadow-xs space-y-4">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-indigo-600 px-2.5 py-0.5 text-[10px] font-bold text-white">
              <Sparkles className="h-3 w-3" />
              100% Free Tools
